...
import com.utsakb.amxy.presenter.FriendHelper;

import static com.utsakb.amxy.presenter.DatabaseContract.NoteColumns.DATE;
import static com.utsakb.amxy.presenter.DatabaseContract.NoteColumns.EMAIL;
import static com.utsakb.amxy.presenter.DatabaseContract.NoteColumns.IG;
import static com.utsakb.amxy.presenter.DatabaseContract.NoteColumns.KELAS;
import static com.utsakb.amxy.presenter.DatabaseContract.NoteColumns.NAMA;
import static com.utsakb.amxy.presenter.DatabaseContract.NoteColumns.NIM;
import static com.utsakb.amxy.presenter.DatabaseContract.NoteColumns.TELPON;
...
public class FriendAddUpdateActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (isEdit){
            ...
            btnTitle = "Update";
            getSupportActionBar().setBackgroundDrawable(new ColorDrawable(Color.parseColor("#C4122A")));
        ...
        if (v.getId() == R.id.btn_Submit){
            ...
            if (isEdit){
                ...
                if (result > 0){
                    ...
                    Toast.makeText(FriendAddUpdateActivity.this, "Gagal mengupdate data", Toast.LENGTH_SHORT).show();
                }
            }else {
                ...
                if (result > 0){
                    ...
                    Toast.makeText(FriendAddUpdateActivity.this, "Gagal menambah data", Toast.LENGTH_SHORT).show();
                }
            }
        }
    }
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        if (isDialogClose){
                            ...
                            if (result > 0){
                                ...
                                Toast.makeText(FriendAddUpdateActivity.this, "Gagal mengahpus data", Toast.LENGTH_SHORT).show();
                            }
                        }
                    }
                })
